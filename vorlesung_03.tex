...
\begin{beispiel}
  ...
  \begin{enumerate}
    \item 
      ...
      \begin{center}
        \begin{tikzpicture}[scale=2]
          \node[dotnode] (a)at(0,0) {} node[left] at(a) {(2)};
          \node[dotnode] (b)at(2,0) {} node[right] at(b) {(1)};
          \node[dotnode] (c)at(1,1) {} node[above] at(c) {(1)};
        \end{tikzpicture}
      \end{center}
    \item 
      Das $1$-Skelet
      \begin{center}
        \begin{tikzpicture}[scale=2]
          \node[dotnode] (a)at(0,0) {} node[below left] at(a) {(2)};
          \node[dotnode] (b)at(2,0) {} node[below right] at(b) {(1)};
          \node[dotnode] (c)at(1,1) {} node[above] at(c) {(1)};
          
          \path[line normal] 
            (a) to[in=135,out=135] (-0.4,-0.4) node[below left] {(2,2)}
              to[in=-45,out=-45] (a);
          \path[line normal] 
            (b) to[in=45,out=45] (2.4,-0.4) node[below right] {(1,1)}
              to[in=-135,out=-135] (b);
          \path[line normal] 
            (c) to[in=0,out=0] (1,1.4) node[above] {(0,0)}
              to[in=180,out=180] (c);
    ...
    \item 
      ...
      \end{center}
    \item 
      welches nach einfügen noch höherer Simplizes vereinfacht gemalt wie folgt
      aussieht
      \begin{center}
        \begin{tikzpicture}[scale=2]
          \node[dotnode] (a)at(0,0) {} node[below left] at(a) {(2)};
          \node[dotnode] (b)at(2,0) {} node[below right] at(b) {(1)};
          \node[dotnode] (c)at(1,1) {} node[above] at(c) {(1)};
          \path[line normal] (a) to (b) to (c) to (a);
        \end{tikzpicture}
      \end{center}
  \end{enumerate}
  \iffalse
